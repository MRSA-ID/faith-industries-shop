  ...
  return (
    ...
    <div className="flex justify-between">
      ...
      <ReactPaginate
        ...
        previousLinkClassName="pg-item flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border !border-blue-100 rounded-s-lg
        hover:bg-blue-100 hover:text-blue-700 hover:border-blue-100 dark:bg-gray-800 dark:!border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
        ...
        activeLinkClassName="flex items-center justify-center px-3 h-8 !text-blue-600 border border-blue-100 bg-blue-100 border-blue-100 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:!bg-gray-700 dark:!text-white"
        ...
        breakClassName="pg-break flex items-center justify-center px-3 h-8 leading-tight bg-white border border-blue-100 bg-blue-100 hover:bg-blue-100 hover:border-blue-100 hover:text-blue-700 !text-blue-600 bg-blue-50 dark:bg-gray-800 dark:border-gray-700 dark:!text-gray-400 dark:hover:bg-gray-700 dark:!bg-gray-700 dark:hover:text-white"
